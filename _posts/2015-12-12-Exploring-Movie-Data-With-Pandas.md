...
<h1 id="Exploring-Blockbuster-Movies-With-Pandas">Exploring Blockbuster Movies With Pandas<a class="anchor-link" href="#Exploring-Blockbuster-Movies-With-Pandas">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>I love movies so I thought it would be fun to analyze some movie data and show off what pandas can do. In this notebook I explore a crowdsourced dataset of Blockbuster movies from 1975 to 2014. The dataset includes the top 10 most popular movies of each year based on reviews/ratings from IMDB and Rotten Tomatoes as well as ticket sales information.</p>
...
<div class=" highlight hl-ipython2"><pre><span class="c"># Standard import</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>The two important features of pandas are the Data Frame and Series. You can see that I imported them above. A data frame is essentially a table. A series is a single column of our data frame.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Read in the csv file using pd.read_csv('file_path'). You can see that I added a parameter to parse the release date column using parse_dates = ['column_name']</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="s">&#39;top_ten_movies_per_year_DFE.csv&#39;</span><span class="p">,</span> <span class="n">parse_dates</span><span class="o">=</span><span class="p">[</span><span class="s">&#39;release_date&#39;</span><span class="p">])</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Now that we've imported our data. We can run .info() to give us a general view of what we have. I like to do this so I can get a general overview of what I have.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">info</span><span class="p">()</span>
</pre></div>
...
audience_freshness    398 non-null float64
poster_url            398 non-null object
rt_audience_score     398 non-null float64
rt_freshness          398 non-null float64
rt_score              398 non-null float64
2015_inflation        398 non-null object
adjusted              398 non-null object
genres                398 non-null object
Genre_1               398 non-null object
Genre_2               369 non-null object
Genre_3               269 non-null object
imdb_rating           398 non-null float64
length                398 non-null float64
rank_in_year          398 non-null float64
rating                398 non-null object
release_date          398 non-null datetime64[ns]
studio                398 non-null object
title                 398 non-null object
worldwide_gross       398 non-null object
year                  398 non-null float64
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's take a look at a small snippet of our imported data frame to see what we have. We can get the first 5 rows of our data frame using .head() method.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Similarly, we can see the last few rows of the dataset using .tail()</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">tail</span><span class="p">()</span>
</pre></div>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>394</th>
      <td>60</td>
      <td>http://resizing.flixster.com/XFNfAAKeokqanZJOB...</td>
      <td>3.2</td>
      <td>56</td>
      <td>6.2</td>
      <td>338.88%</td>
      <td>$161,741,515.00</td>
      <td>Western\nFamily\nComedy</td>
      <td>Western</td>
      <td>Family</td>
      <td>Comedy</td>
    ...
    <tr>
      <th>395</th>
      <td>77</td>
      <td>http://resizing.flixster.com/V6M1TKucdKIV1pTF3...</td>
      <td>3.6</td>
      <td>0</td>
      <td>0.0</td>
      <td>338.88%</td>
      <td>$152,174,306.67</td>
      <td>Drama\nWestern\nWar</td>
      <td>Drama</td>
      <td>Western</td>
      <td>War</td>
    ...
    <tr>
      <th>396</th>
      <td>82</td>
      <td>http://resizing.flixster.com/coMRFsl2YBbDwXYVs...</td>
      <td>3.4</td>
      <td>89</td>
      <td>6.7</td>
      <td>338.88%</td>
      <td>$183,599,406.33</td>
      <td>Mystery\nCrime\nComedy</td>
      <td>Mystery</td>
      <td>Crime</td>
      <td>Comedy</td>
    ...
    <tr>
      <th>398</th>
      <td>67</td>
      <td>http://resizing.flixster.com/cyLfP1xi9FRaJZSBo...</td>
      <td>3.2</td>
      <td>74</td>
      <td>6.8</td>
      <td>31.26%</td>
      <td>$535,885,534.32</td>
      <td>Thriller\nSci-Fi\nDrama</td>
      <td>Thriller</td>
      <td>Sci-Fi</td>
      <td>Drama</td>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>So it looks like two columns, adjusted and worldwide_gross are currencies. Pandas recognizes these columns as strings. Let's also get rid of the $ and comma in adjusted and worldwide_gross columns and convert those columns to floats so we run statistics on those columns later.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;adjusted&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;adjusted&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">replace</span><span class="p">(</span><span class="s">&#39;[\$,]&#39;</span><span class="p">,</span><span class="s">&#39;&#39;</span><span class="p">,</span><span class="n">regex</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span><span class="o">.</span><span class="n">astype</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span>

<span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;worldwide_gross&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;worldwide_gross&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">replace</span><span class="p">(</span><span class="s">&#39;[\$,]&#39;</span><span class="p">,</span><span class="s">&#39;&#39;</span><span class="p">,</span><span class="n">regex</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span><span class="o">.</span><span class="n">astype</span><span class="p">(</span><span class="nb">float</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>All I did here was replace the dollar signs and commas with nothing and convert the values of the column to float.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>It looks pretty good, but not quite. For our particular purposes, the poster_url column is not useful. So let's get rid of that column. It also makes our data frame more compact more easy to look at by getting rid of that column.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span> <span class="o">=</span> <span class="n">blockbusters</span><span class="o">.</span><span class="n">drop</span><span class="p">(</span><span class="s">&#39;poster_url&#39;</span><span class="p">,</span><span class="mi">1</span><span class="p">)</span>

<span class="n">blockbusters</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Notice I specified the column and also put 1 as a parameter. The structure of a pandas data frame is that 0 refers to the row axis and 1 refers to the column axis. Because I was deleting a column, I had to specify 1 otherwise it would give me an error because it defaults to looking at the row axis.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>We can get a little more information by running .describe() on our data to get some general descriptive statistics that may be useful to us.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">describe</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Notice that running .describe() did not display all the columns. This is because that method expects column values to be numeric in nature so anything that isn't numeric won't be displayed in the output. (Note: Earlier I mentioned 'adjusted' and 'worldwide_gross' would be important columns to look at which is why I cleaned those columns up earlier otherwise running .describe() would not produce anything).</p>
<p>You can make some general observations from the descriptive statistics produced. Some that I thought were interesting are the average imdb rating of blockbuster movies is 7.05 and average length of films is 119.2 minutes.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Selecting-Data">Selecting Data<a class="anchor-link" href="#Selecting-Data">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>We can select just specific columns. Note: I run .head() on most of my queries below to prevent huge outputs.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;title&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<pre>0    Captain America: The Winter Soldier
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Pandas gives us an alternative way of doing this is by calling .column_name after the data frame. The result is the same as the previous.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">title</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="p">[[</span><span class="s">&#39;title&#39;</span><span class="p">,</span><span class="s">&#39;imdb_rating&#39;</span><span class="p">]]</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Notice the double brackets. This allows us to select multiple columns by passing a list into our selection and return only those parts of the dataframe back.</p>
<p>We can also do slicing, which is just selecting a range of rows.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="p">[</span><span class="mi">0</span><span class="p">:</span><span class="mi">3</span><span class="p">]</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>We can use the .value_counts() on our data frame to get a count of what we want. I find this method to be particularly useful for many cases as you'll see below. Let's see how many movies are there for each year in our data.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;year&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">value_counts</span><span class="p">()</span><span class="o">.</span><span class="n">sort_index</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Notice I had to add .sort_index() after .value_counts() because if I didn't then python likely would give me the results in random order.</p>
<p>So right now our index has no meaning and goes from 0 to the length of the dataset. It's a generic index given by python. However, we can set our index to be something more meaningful like using title.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">set_index</span><span class="p">(</span><span class="s">&#39;title&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">sort_index</span><span class="p">()</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">title</span> <span class="o">=</span> <span class="n">blockbusters</span><span class="o">.</span><span class="n">set_index</span><span class="p">(</span><span class="s">&#39;title&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">sort_index</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>If you have a meaningful index, you can use .ix() to select your data frame by index name.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">title</span><span class="o">.</span><span class="n">ix</span><span class="p">[</span><span class="s">&#39;Guardians of the Galaxy&#39;</span><span class="p">]</span>
</pre></div>
...
<div class="output_text output_subarea output_execute_result">
<pre>audience_freshness                           93
rt_audience_score                           4.4
rt_freshness                                 91
rt_score                                    7.7
2015_inflation                           -0.26%
adjusted                            7.72159e+08
genres                Sci-Fi\nAdventure\nAction
Genre_1                                  Sci-Fi
Genre_2                               Adventure
Genre_3                                  Action
...
rank_in_year                                  3
rating                                    PG-13
release_date                2014-08-01 00:00:00
studio                           Marvel Studios
worldwide_gross                     7.74177e+08
year                                       2014
Name: Guardians of the Galaxy, dtype: object</pre>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Let's answer some more interesting questions below regarding our data.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="What-are-the-top-10-highest-rated-sci-fi-films?">What are the top 10 highest rated sci-fi films?<a class="anchor-link" href="#What-are-the-top-10-highest-rated-sci-fi-films?">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="p">[(</span><span class="n">blockbusters</span><span class="o">.</span><span class="n">Genre_1</span> <span class="o">==</span> <span class="s">&#39;Sci-Fi&#39;</span><span class="p">)</span> <span class="o">|</span> <span class="p">(</span><span class="n">blockbusters</span><span class="o">.</span><span class="n">Genre_2</span> <span class="o">==</span> <span class="s">&#39;Sci-Fi&#39;</span><span class="p">)</span> <span class="o">|</span> <span class="p">(</span><span class="n">blockbusters</span><span class="o">.</span><span class="n">Genre_3</span> <span class="o">==</span> <span class="s">&#39;Sci-Fi&#39;</span><span class="p">)][[</span><span class="s">&#39;title&#39;</span><span class="p">,</span><span class="s">&#39;imdb_rating&#39;</span><span class="p">,</span><span class="s">&#39;Genre_1&#39;</span><span class="p">,</span><span class="s">&#39;Genre_2&#39;</span><span class="p">,</span><span class="s">&#39;Genre_3&#39;</span><span class="p">]]</span><span class="o">.</span><span class="n">sort_values</span><span class="p">(</span><span class="n">by</span><span class="o">=</span><span class="s">&#39;imdb_rating&#39;</span><span class="p">,</span><span class="n">ascending</span><span class="o">=</span><span class="bp">False</span><span class="p">)</span><span class="o">.</span><span class="n">head</span><span class="p">(</span><span class="mi">10</span><span class="p">)</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="How-many-movies-do-we-have-for-each-MPAA-rating-group?">How many movies do we have for each MPAA rating group?<a class="anchor-link" href="#How-many-movies-do-we-have-for-each-MPAA-rating-group?">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">ratings</span> <span class="o">=</span> <span class="n">blockbusters</span><span class="p">[</span><span class="s">&#39;rating&#39;</span><span class="p">]</span><span class="o">.</span><span class="n">value_counts</span><span class="p">()</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>It looks like our dataset contains mostly PG-13 rated movies. Let's plot this below.</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">ratings</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span><span class="n">kind</span><span class="o">=</span><span class="s">&#39;bar&#39;</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="s">&quot;MPAA Ratings Frequencies&quot;</span><span class="p">)</span>
<span class="n">plt</span><span class="o">.</span><span class="n">xlabel</span><span class="p">(</span><span class="s">&quot;Rating&quot;</span><span class="p">)</span>
...
<div class="output_text output_subarea output_execute_result">
<pre>&lt;matplotlib.text.Text at 0xa4c75f8&gt;</pre>
</div>
...
<img src="data:image/png;base64,
"
>
</div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Below I will start using the groupby function quite a bit. It's an extremely useful method that will allow us to group our data frame so we can ask more interesting questions.</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Which-years-had-the-highest-average-rating?">Which years had the highest average rating?<a class="anchor-link" href="#Which-years-had-the-highest-average-rating?">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s">&#39;year&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">mean</span><span class="p">()[[</span><span class="s">&#39;imdb_rating&#39;</span><span class="p">]]</span><span class="o">.</span><span class="n">sort_values</span><span class="p">(</span><span class="s">&#39;imdb_rating&#39;</span><span class="p">,</span><span class="n">ascending</span><span class="o">=</span><span class="bp">False</span><span class="p">)</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Which-genre-of-movie-has-the-highest-gross?">Which genre of movie has the highest gross?<a class="anchor-link" href="#Which-genre-of-movie-has-the-highest-gross?">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s">&#39;Genre_1&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">sum</span><span class="p">()[[</span><span class="s">&#39;worldwide_gross&#39;</span><span class="p">]]</span><span class="o">.</span><span class="n">sort_values</span><span class="p">(</span><span class="s">&#39;worldwide_gross&#39;</span><span class="p">,</span><span class="n">ascending</span><span class="o">=</span><span class="bp">False</span><span class="p">)</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Which-studios-earned-the-highest-average-amount-per-movie?">Which studios earned the highest average amount per movie?<a class="anchor-link" href="#Which-studios-earned-the-highest-average-amount-per-movie?">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">groupby</span><span class="p">(</span><span class="s">&#39;studio&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">mean</span><span class="p">()[[</span><span class="s">&#39;worldwide_gross&#39;</span><span class="p">]]</span><span class="o">.</span><span class="n">sort_values</span><span class="p">(</span><span class="s">&#39;worldwide_gross&#39;</span><span class="p">,</span><span class="n">ascending</span><span class="o">=</span><span class="bp">False</span><span class="p">)</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <th>Warner Bros. / MGM / New Line</th>
      <td>1.017004e+09</td>
    </tr>
    <tr>
      <th>Paramount Pictures / 20th Century Fox</th>
      <td>1.009002e+09</td>
    </tr>
    <tr>
    ...
    <tr>
      <th>Warner Bros. / New Line / MGM</th>
      <td>9.603669e+08</td>
    </tr>
  </tbody>
</table>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="Which-studios-released-the-most-films?">Which studios released the most films?<a class="anchor-link" href="#Which-studios-released-the-most-films?">&#182;</a></h3>
</div>
</div>
</div>
<div class="cell border-box-sizing code_cell rendered">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython2"><pre><span class="n">blockbusters</span><span class="o">.</span><span class="n">studio</span><span class="o">.</span><span class="n">value_counts</span><span class="p">()</span><span class="o">.</span><span class="n">head</span><span class="p">()</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p>Dataset retrieved from: <a href="http://www.crowdflower.com/data-for-everyone">http://www.crowdflower.com/data-for-everyone</a></p>
